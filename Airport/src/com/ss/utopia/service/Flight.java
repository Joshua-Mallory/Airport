...
public class Flight {
	...
	public Flight(Integer id, Integer route_id, Integer airplane_id, Date departure_time_date, Time departure_time_time,
			Integer reserved_econ, Integer reserved_bus, Integer reserved_first, float econ_price, float bus_price,
			float first_price) {
		this.id = id;
	...
	public Flight getFlightData(Integer routeID) throws Exception {
		...
		Flight f = new Flight(id, route_id, airplane_id, departure_time_date, departure_time_time, reserved_econ,
				reserved_bus, reserved_first, econ_price, bus_price, first_price);
		return f;
	}
